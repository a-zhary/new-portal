        ...
        /******/ ([
                ...
                var Extension = function () {
                    ...
                    function Extension(colorpicker) {
                        ...
                        if (!(this.colorpicker.element &&
                            this.colorpicker.element.length)) {
                            throw new Error(
                ...
                var Palette = function (_Extension) {
                    ...
                    function Palette(colorpicker) {
                        ...
                        var _this = _possibleConstructorReturn(this,
                            (Palette.__proto__ ||
                                Object.getPrototypeOf(Palette)).call(this,
                                colorpicker,
                                Object.assign({}, defaults, options)))

                        if (!Array.isArray(_this.options.colors) &&
                    ...
                    _createClass(Palette, [
                        {
                            ...
                            value: function resolveColor(color) {
                                ...
                                if (Array.isArray(this.options.colors)) {
                                    if (this.options.colors.indexOf(color) >=
                                        0) {
                                        return color
                                    }
                                    if (this.options.colors.indexOf(
                                        color.toUpperCase()) >= 0) {
                            ...
                            value: function getName(value) {
                                var defaultValue = arguments.length > 1 &&
                                ...
                                for (var name in this.options.colors) {
                                    if (!this.options.colors.hasOwnProperty(
                                        name)) {
                                        continue
                                    }
                                    if (this.options.colors[name].toLowerCase() ===
                                        value.toLowerCase()) {
                                        return name
                                    }
                                }
                ...
                _jquery2.default.fn[plugin] = function (option) {
                    ...
                    var $jq = this.each(function () {
                        var $this = (0, _jquery2.default)(this),
                            ...
                            options = (typeof option === 'undefined'
                                ? 'undefined'
                        ...
                        if (typeof option === 'string') {
                            if (option === 'colorpicker') {
                                returnValue = inst
                            } else if (_jquery2.default.isFunction(
                                inst[option])) {
            ...
            /***/ (function (module, exports, __webpack_require__) {
                ...
                var Colorpicker = function () {
                    ...
                    function Colorpicker(element, options) {
                         ...
                         * @type {defaults}
                         */
                        this.options = Object.assign({}, _options2.default,
                        ...
                        this.component = this.component !== false
                            ? this.element.find(this.component)
                            : false
                         ...
                         * @type {*|jQuery}
                         */
                        this.container = this.options.container === true
                            ? this.element
                            : this.options.container
                        this.container = this.container !== false
                        ...
                        this.input = this.element.is('input')
                            ? this.element
                            : this.options.input ? this.element.find(
                        ...
                        this.options.extensions.forEach(function (ext) {
                            _this.addExtension(ext.name,
                                _extensions2.default[ext.name.toLowerCase()],
                                ext)
                        })

                        var colorValue = this.options.color !== false
                            ? this.options.color
                            : this.getValue()

                        this.color = colorValue
                            ? this.createColor(colorValue)
                            : false
                        ...
                        if ((this.options.useAlpha || this.hasColor() &&
                        ...
                        $picker.find(
                            ...
                            on('mousedown.colorpicker touchstart.colorpicker',
                                _jquery2.default.proxy(this._mousedown, this))
                        ...
                        if (this.component !== false) {
                            this.component.on({
                                'click.colorpicker': _jquery2.default.proxy(
                                    this.show, this),
                            })
                        }

                        if (this.hasInput() === false && this.component ===
                            false && !this.element.has('.colorpicker')) {
                            this.element.on({
                                'click.colorpicker': _jquery2.default.proxy(
                                    this.show, this),
                            })
                        ...
                        if (this.hasInput() && this.component !== false &&
                    ...
                    _createClass(Colorpicker, [
                        {
                            ...
                            value: function _reposition(e) {
                                ...
                                var type = this.container &&
                                this.container[0] !== window.document.body
                                    ? 'position'
                                    : 'offset'
                                ...
                                if (this.options.align === 'right') {
                                    offset.left -= this.picker.outerWidth() -
                                        element.outerWidth()
                                }
                                this.picker.css({
                            ...
                            value: function show(e) {
                                ...
                                this.picker.addClass('colorpicker-visible').
                                    removeClass('colorpicker-hidden')

                                this._reposition(e);
                                (0, _jquery2.default)(window).
                                    on('resize.colorpicker',
                                        _jquery2.default.proxy(this._reposition,
                                            this))
                                ...
                                if ((this.component || !this.input) &&
                                    this.options.inline === false) {
                                    (0, _jquery2.default)(window.document).on({
                                        'mousedown.colorpicker': _jquery2.default.proxy(
                                            this.hide, this),
                                    })
                                }
                            ...
                            value: function hide(e) {
                                ...
                                if (typeof e !== 'undefined' && e.target) {
                                    ...
                                    if ((0, _jquery2.default)(e.currentTarget).
                                            parents('.colorpicker').length > 0 ||
                                        (0, _jquery2.default)(e.target).
                                            parents('.colorpicker').length >
                                        0) {
                                        return false
                                    }
                                }
                                ...
                                (0, _jquery2.default)(window).
                                    off('resize.colorpicker', this._reposition);
                            ...
                            value: function isVisible() {
                                return this.picker.hasClass(
                                        'colorpicker-visible') &&
                                    !this.picker.hasClass('colorpicker-hidden')
                            },
                            ...
                            value: function _updatePicker() {
                                ...
                                var vertical = this.options.horizontal ===
                                        false,
                                    sl = vertical
                                ...
                                if (hueGuide.length) {
                                    hueGuide.css(vertical ? 'top' : 'left',
                                        (vertical
                                            ? sl.hue.maxTop
                                            : sl.hue.maxLeft) * (1 - hsva.h))
                                }

                                if (alphaGuide.length) {
                                    alphaGuide.css(vertical ? 'top' : 'left',
                                        (vertical
                                            ? sl.alpha.maxTop
                                            : sl.alpha.maxLeft) * (1 - hsva.a))
                                }

                                if (saturationGuide.length) {
                                    saturationGuide.css({
                                        'top': sl.saturation.maxTop - hsva.v *
                                ...
                                this.picker.find('.colorpicker-saturation').
                                    css('backgroundColor',
                                        this.color.getHueOnlyCopy().
                                            toHexString()) // we only need hue

                                this.picker.find('.colorpicker-alpha').
                                    css('backgroundColor',
                                        this.color.toString('hex6')) // we don't need alpha
                            },
                            ...
                            value: function update() {
                                ...
                                if (this._shouldUpdate() || force === true) {
                                    ...
                                    var preventInputUpdate = this.options.autoInputFallback !==
                                        true &&
                            ...
                            value: function getValue() {
                                var defaultValue = arguments.length > 0 &&
                                arguments[0] !== undefined
                                    ? arguments[0]
                                    : null

                                defaultValue = typeof defaultValue ===
                                'undefined' ? this.fallbackColor : defaultValue
                                var candidates = [],
                                    val = false
                            ...
                            value: function setValue(val) {
                                ...
                                var shouldForceUpdate = this.hasColor() &&
                                    !color
                            ...
                            value: function createColor(val) {
                                var useFallback = arguments.length > 1 &&
                                arguments[1] !== undefined
                                    ? arguments[1]
                                    : true

                                var color = new _Color2.default(
                                    this._resolveColor(val),
                                    { format: this.format })
                                ...
                                if (!color.isValid()) {
                                    ...
                                    if (useFallback) {
                                        fallback = this.fallbackColor instanceof
                                        _Color2.default &&
                                        this.fallbackColor.isValid()
                                            ? this.fallbackColor
                                            : this._resolveColor(
                                                this.fallbackColor)

                                        color = new _Color2.default(fallback,
                                            { format: this.format })

                                        if (!color.isValid() && useFallback) {
                                            throw new Error(
                                                'The fallback color is invalid.')
                                        }
                                    }
                            ...
                            value: function _resolveColor(color) {
                                ...
                                _jquery2.default.each(this.extensions,
                                    function (name, ext) {
                                        if (extResolvedColor !== false) {
                                            // skip if resolved
                                            return
                                        }
                                        extResolvedColor = ext.resolveColor(
                                            color)
                                    })
                            ...
                            value: function _mousedown(e) {
                                ...
                                if (!zone.is('.colorpicker')) {
                                    if (zone.is('.colorpicker-saturation')) {
                                        this.currentSlider = _jquery2.default.extend(
                                            {}, sl.saturation)
                                    ...
                                    this.currentSlider.guide = zone.find(
                                        '.colorpicker-guide')[0].style
                            ...
                            value: function _mousemove(e) {
                                ...
                                var color = !this.hasColor() ? this.createColor(
                                    this.fallbackColor) : this.color.getCopy()
                                ...
                                if (this.currentSlider.callLeft) {
                                    color[this.currentSlider.callLeft].call(
                                        color,
                                        left / this.currentSlider.maxLeft)
                                }
                                if (this.currentSlider.callTop) {
                                    color[this.currentSlider.callTop].call(
                                        color, top / this.currentSlider.maxTop)
                                }
                            ...
                            get: function get() {
                                ...
                                if (this.hasColor() &&
                                    ...
                                    return this.options.enableHex8
                                        ? 'hex8'
                                        : this.isAlphaEnabled()
                                            ? 'rgba'
                                            : 'hex'
            ...
            /***/ (function (module, exports, __webpack_require__) {
                ...
                function getCompatibleFormat(format) {
                    if (format instanceof String || typeof format ===
                        'string') {
                ...
                var Color = function (_tinycolor) {
                    ...
                    function Color(color) {
                        var options = arguments.length > 1 && arguments[1] !==
                        undefined ? arguments[1] : { format: null }

                        _classCallCheck(this, Color)

                        if (options.format) {
                            options.format = getCompatibleFormat(
                                options.format)
                        }
                        ...
                        var _this = _possibleConstructorReturn(this,
                            (Color.__proto__ ||
                                Object.getPrototypeOf(Color)).call(this,
                                unwrapColor(color), options))
                    ...
                    _createClass(Color, [
                        {
                            ...
                            value: function equals(color) {
                                ...
                                return this._r === color._r && this._g ===
                                    color._g && this._b === color._b &&
                                    this._a === color._a && this._roundA ===
                                    color._roundA && this._format ===
                                    color._format && this._gradientType ===
                                    color._gradientType && this._ok ===
                                    color._ok
                            },
                            ...
                            value: function importColor(color) {
                                if (!(color instanceof _tinycolor3.default)) {
                                    throw new Error(
                                        'Color.importColor: The color argument is not an instance of tinycolor.')
                                }
                                ...
                                this._format = getCompatibleFormat(
                                    color._format)
                            ...
                            value: function getHueOnlyCopy() {
                                return new Color({
                                    h: this._hbak ? this._hbak : this.hsva.h,
                                    s: 100,
                                    v: 100,
                                }, this.options)
                            },
                            ...
                            value: function toString() {
                                ...
                                var colorStr = _get(Color.prototype.__proto__ ||
                                    Object.getPrototypeOf(Color.prototype),
                                    'toString', this).call(this, format)

                                if (colorStr &&
                                    colorStr.match(/^#[0-9a-f]{3,8}$/i)) {
                                    // Support transparent for hex formats
                                    if (this.isTransparent() && this._r === 0 &&
                                        this._g === 0 && this._b === 0) {
                                        return 'transparent'
                                    }
                                }
                ...
                (function (Math) {
                    ...
                    tinycolor.prototype = {
                        ...
                        toRgbString: function () {
                            return (this._a == 1) ?
                                'rgb(' + mathRound(this._r) + ', ' +
                                mathRound(this._g) + ', ' + mathRound(this._b) +
                                ')' :
                                'rgba(' + mathRound(this._r) + ', ' +
                                mathRound(this._g) + ', ' + mathRound(this._b) +
                                ', ' + this._roundA + ')'
                        },
                        ...
                        toName: function () {
                            ...
                            return hexNames[rgbToHex(this._r, this._g, this._b,
                                true)] || false
                        },
                        toFilter: function (secondColor) {
                            var hex8String = '#' +
                                rgbaToArgbHex(this._r, this._g, this._b,
                                    this._a)
                            ...
                            return 'progid:DXImageTransform.Microsoft.gradient(' +
                                gradientType + 'startColorstr=' + hex8String +
                                ',endColorstr=' + secondHex8String + ')'
                        },
                        ...
                        desaturate: function () {
                            return this._applyModification(desaturate,
                                arguments)
                        },
                        saturate: function () {
                        ...
                        complement: function () {
                            return this._applyCombination(complement,
                                arguments)
                        },
                        monochromatic: function () {
                            return this._applyCombination(monochromatic,
                                arguments)
                        },
                        splitcomplement: function () {
                            return this._applyCombination(splitcomplement,
                                arguments)
                        },
                        triad: function () {
                            ...
                            for (var i in color) {
                                if (color.hasOwnProperty(i)) {
                                    if (i === 'a') {
                                        ...
                                        newColor[i] = convertToPercentage(
                                            color[i])
                                    }
                                }
                            }
                    ...
                    function inputToRGB(color) {
                        ...
                        if (typeof color == 'object') {
                            if (isValidCSSUnit(color.r) &&
                                ...
                                ok = true
                                format = String(color.r).substr(-1) === '%'
                                    ? 'prgb'
                                    : 'rgb'
...
// Returns a 3 or 6 character hex
                    function rgbToHex(r, g, b, allow3Char) {
                        ...
                        if (allow3Char && hex[0].charAt(0) ==
                            hex[0].charAt(1) && hex[1].charAt(0) ==
                            hex[1].charAt(1) && hex[2].charAt(0) ==
                            hex[2].charAt(1)) {
...
// a in [0, 1]. Returns a 4 or 8 character rgba hex
                    function rgbaToHex(r, g, b, a, allow4Char) {
                        ...
                        if (allow4Char && hex[0].charAt(0) ==
                            hex[0].charAt(1) && hex[1].charAt(0) ==
                            hex[1].charAt(1) && hex[2].charAt(0) ==
                            hex[2].charAt(1) && hex[3].charAt(0) ==
                            hex[3].charAt(1)) {
                            return hex[0].charAt(0) + hex[1].charAt(0) +
                                hex[2].charAt(0) + hex[3].charAt(0)
                        }
...
// <https://github.com/cloudhead/less.js/blob/master/lib/less/functions.js>
                    ...
                    function brighten(color, amount) {
                        ...
                        rgb.r = mathMax(0, mathMin(255,
                            rgb.r - mathRound(255 * -(amount / 100))))
                        rgb.g = mathMax(0, mathMin(255,
                            rgb.g - mathRound(255 * -(amount / 100))))
                        rgb.b = mathMax(0, mathMin(255,
                            rgb.b - mathRound(255 * -(amount / 100))))
...
// Analyze the 2 colors and returns the color contrast defined by (WCAG Version 2)
                    tinycolor.readability = function (color1, color2) {
                        ...
                        return (Math.max(c1.getLuminance(), c2.getLuminance()) +
                                0.05) /
...
//    tinycolor.mostReadable("#a8015a", ["#faf3f3"],{includeFallbackColors:true,level:"AAA",size:"small"}).toHexString(); // "#ffffff"
                    tinycolor.mostReadable = function (
                        ...
                        for (var i = 0; i < colorList.length; i++) {
                            readability = tinycolor.readability(baseColor,
                                colorList[i])
...
// Converts a hex value to a decimal
                    ...
                    var matchers = (function () {
                        ...
                        var PERMISSIVE_MATCH3 = '[\\s|\\(]+(' + CSS_UNIT +
                            ')[,|\\s]+(' + CSS_UNIT + ')[,|\\s]+(' + CSS_UNIT +
                            ')\\s*\\)?'
                        var PERMISSIVE_MATCH4 = '[\\s|\\(]+(' + CSS_UNIT +
                            ')[,|\\s]+(' + CSS_UNIT + ')[,|\\s]+(' + CSS_UNIT +
                            ')[,|\\s]+(' + CSS_UNIT + ')\\s*\\)?'
...
// AMD/requirejs: Define the module
                        ...
                        !(__WEBPACK_AMD_DEFINE_RESULT__ = function () {return tinycolor}.call(
            ...
            /***/ (function (module, exports, __webpack_require__) {
                ...
                var Debugger = function (_Extension) {
                    ...
                    function Debugger(colorpicker) {
                        ...
                        var _this = _possibleConstructorReturn(this,
                            (Debugger.__proto__ ||
                                Object.getPrototypeOf(Debugger)).call(this,
                                colorpicker, options))

                        _this.eventCounter = 0
                        if (_this.colorpicker.hasInput()) {
                            _this.colorpicker.input.on('change.colorpicker-ext',
                                _jquery2.default.proxy(_this.onChangeInput,
                                    _this))
                        }
                        return _this
                    }
                    ...
                    _createClass(Debugger, [
                        {
                            ...
                            value: function log(eventName) {
                                ...
                                for (var _len = arguments.length, args = Array(
                                    _len > 1 ? _len - 1 : 0), _key = 1; _key <
                                _len; _key++) {
                                ...
                                var logMessage = '#' + this.eventCounter +
                                    ': Colorpicker#' + this.colorpicker.id +
                                    ' [' + eventName + ']';
                            ...
                            value: function onCreate(event) {
                                ...
                                return _get(Debugger.prototype.__proto__ ||
                                    Object.getPrototypeOf(Debugger.prototype),
                                    'onCreate', this).call(this, event)
                            },
                        }, {
                            key: 'onDestroy',
                            value: function onDestroy(event) {
                                ...
                                if (this.colorpicker.hasInput()) {
                                    this.colorpicker.input.off(
                                        '.colorpicker-ext')
                                }

                                return _get(Debugger.prototype.__proto__ ||
                                    Object.getPrototypeOf(Debugger.prototype),
                                    'onDestroy', this).call(this, event)
                            },
                        }, {
                            key: 'onUpdate',
                            value: function onUpdate(event) {
                            ...
                            value: function onChangeInput(event) {
                                this.log('input:change.colorpicker',
                                    event.value, event.color)
                            },
                        }, {
                            key: 'onChange',
                            value: function onChange(event) {
                                this.log('colorpickerChange', event.value,
                                    event.color)
                            },
                        }, {
                            key: 'onInvalid',
                            value: function onInvalid(event) {
                                this.log('colorpickerInvalid', event.value,
                                    event.color)
                            },
                        }, {
                            key: 'onHide',
            ...
            /***/ (function (module, exports, __webpack_require__) {
                ...
                var Preview = function (_Extension) {
                    ...
                    function Preview(colorpicker) {
                        ...
                        var _this = _possibleConstructorReturn(this,
                            (Preview.__proto__ ||
                                Object.getPrototypeOf(Preview)).call(this,
                        ...
                        _this.element = (0, _jquery2.default)(
                    ...
                    _createClass(Preview, [
                        {
                            key: 'onCreate',
                            value: function onCreate(event) {
                                _get(Preview.prototype.__proto__ ||
                            ...
                            value: function onUpdate(event) {
                                _get(Preview.prototype.__proto__ ||
                                    Object.getPrototypeOf(Preview.prototype),
                                    'onUpdate', this).call(this, event)

                                this.elementInner.css('backgroundColor',
                                    event.color.toRgbString())

                                if (this.options.showText) {
                                    this.elementInner.html(event.color.toString(
                                        this.options.format ||
                                        this.colorpicker.format))
                ...
                var Swatches = function (_Palette) {
                    ...
                    function Swatches(colorpicker) {
                        ...
                        return _possibleConstructorReturn(this,
                            (Swatches.__proto__ ||
                                Object.getPrototypeOf(Swatches)).call(this,
                                colorpicker,
                                Object.assign({}, defaults, options)))
                    }
                    ...
                    _createClass(Swatches, [
                        {
                            ...
                            value: function onCreate(event) {
                                ...
                                _get(Swatches.prototype.__proto__ ||
                                ...
                                var colorpicker = this.colorpicker,
                                    swatchContainer = (0, _jquery2.default)(
                                        this.options.barTemplate),
                                    isAliased = this.options.namesAsValues ===
                                        true && !Array.isArray(this.colors)

                                _jquery2.default.each(this.colors,
                                    function (name, value) {
                                        ...
                                        $swatch.on(
                                            ...
                                            function (e) {
                                                e.preventDefault()
                                                colorpicker.setValue(isAliased
                                                    ? (0, _jquery2.default)(
                                                        this).data('name')
                                                    : (0, _jquery2.default)(
                                                        this).data('value'))
