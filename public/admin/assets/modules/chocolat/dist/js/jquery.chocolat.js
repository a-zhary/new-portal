    ...
    $.extend(Chocolat.prototype, {
        ...
        fit: function (i, container) {
            ...
            if (this.settings.imageSize == 'cover') {
                ...
                if (this.settings.imageSize === 'default' &&
        ...
        storeImgSize: function (img, i) {
            ...
            if (!this.settings.images[i].height ||
                !this.settings.images[i].width) {
        ...
        destroy: function () {
            ...
            this.element.find(this.settings.imageSelector).
                off('click.chocolat')
        ...
        getOutMarginH: function () {
            return this.elems.top.outerHeight(true) +
                this.elems.bottom.outerHeight(true)
        },
        ...
        events: function () {
            ...
            this.elems.fullscreen.off('click.chocolat').
                on('click.chocolat', function () {
            ...
            if (that.settings.backgroundClose) {
                this.elems.overlay.off('click.chocolat').
                    on('click.chocolat', function () {
                        return that.close()
                    })
            }
            this.elems.wrapper.off('click.chocolat').
                on('click.chocolat', function (e) {
            ...
            this.elems.wrapper.mousemove(function (e) {
                ...
                var mvtX = 0
                if (imgWidth > width) {
                    var paddingX = that.settings.zoomedPaddingX(imgWidth,
                        width)
                ...
                var mvtY = 0
                if (imgHeight > height) {
                    var paddingY = that.settings.zoomedPaddingY(imgHeight,
                        height)
            ...
            $(window).on('resize', function () {
                if (!that.settings.initialized || that.settings.currentImage ===
                    false) {
                    return
                }
                that.debounce(50, function () {
                    var fitting = that.fit(that.settings.currentImage,
                        that.elems.wrapper)
                    that.center(fitting.width, fitting.height, fitting.left,
                        fitting.top, 0)
                    that.zoomable()
                })
            })
        ...
        zoomable: function () {
            ...
            var isImageZoomable = (this.settings.enableZoom &&
                (currentImage.width > wrapperWidth || currentImage.height >
                    wrapperHeight)) ? true : false
            var isImageStretched = this.elems.img.width() >
                currentImage.width || this.elems.img.height() >
                currentImage.height
        ...
        zoomIn: function (e) {
            ...
            var fitting = this.fit(this.settings.currentImage,
                this.elems.wrapper)
            return this.center(fitting.width, fitting.height, fitting.left,
                fitting.top, this.settings.duration)
        },
        ...
        api: function () {
            ...
            return {
                ...
                place: function () {
                    return that.place(that.settings.currentImage,
