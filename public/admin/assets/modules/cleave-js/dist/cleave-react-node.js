            ...
            /***/ (function (module, exports, __webpack_require__) {
                ...
                function factory(
                    ...
                    function validateMethodOverride(isAlreadyDefined, name) {
                        ...
                        if (isAlreadyDefined) {
                            _invariant(
                                specPolicy === 'DEFINE_MANY' || specPolicy ===
                                'DEFINE_MANY_MERGED',
                    ...
                    function mixSpecIntoComponent(Constructor, spec) {
                        if (!spec) {
                            if (process.env.NODE_ENV !== 'production') {
                                ...
                                var isMixinValid = typeofSpec === 'object' &&
                                    spec !== null
            ...
            /***/ (function (module, exports, __webpack_require__) {
                ...
                if (process.env.NODE_ENV !== 'production') {
                    ...
                    warning = function warning(condition, format) {
                        ...
                        if (format.indexOf('Failed Composite propType: ') ===
                            0) {
                        ...
                        if (!condition) {
                            for (var _len2 = arguments.length, args = Array(
                                _len2 > 2 ? _len2 - 2 : 0), _key2 = 2; _key2 <
                            _len2; _key2++) {
            ...
            /***/ (function (module, exports) {
                ...
                var DefaultProperties = {
                    ...
                    assign: function assign(target, opts) {
                        ...
                        // others
                        target.numericOnly = target.creditCard || target.date ||
                            !!opts.numericOnly
