        ...
        /******/ ([
            ...
            /***/ (function (module, exports, __webpack_require__) {
                ...
                var cleaveReactClass = CreateReactClass({
                    ...
                    componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
                        var owner = this,
                            phoneRegionCode = (nextProps.options ||
                                {}).phoneRegionCode,
                        ...
                        if (newValue !== undefined) {
                            ...
                            if (newValue !== owner.state.value && newValue !==
                        ...
                        if (phoneRegionCode && phoneRegionCode !==
                            owner.properties.phoneRegionCode) {
                    ...
                    init: function init() {
                        ...
                        if (!pps.numeral && !pps.phone && !pps.creditCard &&
                            !pps.date && pps.blocksLength === 0 &&
                            !pps.prefix) {
                    ...
                    initNumeralFormatter: function initNumeralFormatter() {
                        ...
                        pps.numeralFormatter = new NumeralFormatter(
                            pps.numeralDecimalMark, pps.numeralIntegerScale,
                            pps.numeralDecimalScale,
                            pps.numeralThousandsGroupStyle,
                            pps.numeralPositiveOnly, pps.stripLeadingZeroes,
                            pps.delimiter)
                    },
                    ...
                    initPhoneFormatter: function initPhoneFormatter() {
                        ...
                        try {
                            pps.phoneFormatter = new PhoneFormatter(
                                new pps.root.Cleave.AsYouTypeFormatter(
                                    pps.phoneRegionCode), pps.delimiter)
                        } catch (ex) {
                            throw new Error(
                    ...
                    getRawValue: function getRawValue() {
                        ...
                        if (pps.rawValueTrimPrefix) {
                            rawValue = Util.getPrefixStrippedValue(rawValue,
                                pps.prefix, pps.prefixLength)
                        }

                        if (pps.numeral) {
                            rawValue = pps.numeralFormatter.getRawValue(
                                rawValue)
                        } else {
                            rawValue = Util.stripDelimiters(rawValue,
                                pps.delimiter, pps.delimiters)
                        }
                    ...
                    onKeyDown: function onKeyDown(event) {
                        ...
                        if (charCode === 8 && Util.isDelimiter(
                    ...
                    onInput: function onInput(value, fromProps) {
                        ...
                        if (Util.isAndroidBackspaceKeydown(owner.lastInputValue,
                            owner.element.value) && Util.isDelimiter(
                            pps.result.slice(-pps.delimiterLength),
                            pps.delimiter, pps.delimiters)) {
                            pps.backspace = true
                        }
                        ...
                        if (!fromProps && !pps.numeral && pps.backspace &&
                            !Util.isDelimiter(value.slice(-pps.delimiterLength),
                                pps.delimiter, pps.delimiters)) {
                            value = Util.headStr(value,
                                value.length - pps.delimiterLength)
                        }
                        ...
                        if (pps.numeral) {
                            if (pps.prefix &&
                                (!pps.noImmediatePrefix || value.length)) {
                                pps.result = pps.prefix +
                                    pps.numeralFormatter.format(value)
                            } else {
                        ...
                        // strip delimiters
                        value = Util.stripDelimiters(value, pps.delimiter,
                            pps.delimiters)
                        ...
                        value = pps.maxLength > 0 ? Util.headStr(value,
                            pps.maxLength) : value

                        // apply blocks
                        pps.result = Util.getFormattedValue(value, pps.blocks,
                            pps.blocksLength, pps.delimiter, pps.delimiters,
                    ...
                    updateCreditCardPropsByValue: function updateCreditCardPropsByValue(value) {
                        ...
                        if (Util.headStr(pps.result, 4) ===
                            Util.headStr(value, 4)) {
                            return
                        }

                        creditCardInfo = CreditCardDetector.getInfo(value,
                        ...
                        if (pps.creditCardType !== creditCardInfo.type) {
                            ...
                            pps.onCreditCardTypeChanged.call(owner,
                                pps.creditCardType)
                        }
                    },

                    getNextCursorPosition: function getNextCursorPosition(
                        endPos, oldValue, newValue) {
                    ...
                    setCurrentSelection: function setCurrentSelection(cursorPosition) {
                        ...
                        if (elem === document.activeElement) {
                            if (elem.createTextRange) {
                                ...
                                elem.setSelectionRange(cursorPosition,
                                    cursorPosition)
                            }
                        }
                    },
                    ...
                    updateValueState: function updateValueState() {
                        ...
                        var nextCursorPosition = owner.getNextCursorPosition(
                            endPos, oldValue, newValue)
                    ...
                    render: function render() {
                        ...
                        var _owner$props2 = owner.props,
                            ...
                            propsToTransfer = _objectWithoutProperties(
                                _owner$props2, [
                                    'value',
                                    'options',
                                    'onKeyDown',
                    ...
                    function factory(
                        ...
                        var RESERVED_SPEC_KEYS = {
                            ...
                            childContextTypes: function (
                                ...
                                if (process.env.NODE_ENV !== 'production') {
                                    validateTypeDef(Constructor,
                                        childContextTypes, 'childContext')
                                }
                            ...
                            contextTypes: function (Constructor, contextTypes) {
                                if (process.env.NODE_ENV !== 'production') {
                                    validateTypeDef(Constructor, contextTypes,
                                        'context')
                                }
                            ...
                            propTypes: function (Constructor, propTypes) {
                                if (process.env.NODE_ENV !== 'production') {
                                    validateTypeDef(Constructor, propTypes,
                                        'prop')
                                }
                            ...
                            statics: function (Constructor, statics) {
                                mixStaticSpecIntoComponent(Constructor,
                                    statics)
                            },
                            autobind: function () {},
                        }
                        ...
                        function mixSpecIntoComponent(Constructor, spec) {
                            ...
                            if (spec.hasOwnProperty(MIXINS_KEY)) {
                                RESERVED_SPEC_KEYS.mixins(Constructor,
                                    spec.mixins)
                            }
                            ...
                            for (var name in spec) {
                                ...
                                if (RESERVED_SPEC_KEYS.hasOwnProperty(name)) {
                                    RESERVED_SPEC_KEYS[name](Constructor,
                                        property)
                                } else {
                                    ...
                                    var isReactClassMethod = ReactClassInterface.hasOwnProperty(
                                        name)
                                    var isFunction = typeof property ===
                                        'function'
                                    var shouldAutoBind =
                                        isFunction &&
                                        !isReactClassMethod &&
                                        ...
                                        if (isAlreadyDefined) {
                                            ...
                                            if (process.env.NODE_ENV !==
                                                ...
                                                if (typeof property ===
                                                    'function' &&
                                                    spec.displayName) {
                                                    proto[name].displayName = spec.displayName +
                                                        '_' + name
                                                }
                                            }
                                        }
                        ...
                        function bindAutoBindMethod(component, method) {
                            ...
                            if (process.env.NODE_ENV !== 'production') {
                                ...
                                boundMethod.bind = function (newThis) {
                                    ...
                                    var reboundMethod = _bind.apply(boundMethod,
                                        arguments)
            ...
            /***/ (function (module, exports) {
                ...
                function runTimeout(fun) {
                    ...
                    if ((cachedSetTimeout === defaultSetTimout ||
                        !cachedSetTimeout) && setTimeout) {
                        cachedSetTimeout = setTimeout
                        return setTimeout(fun, 0)
                    }
                ...
                */
                ...
                function shouldUseNative() {
                    try {
                        ...
                        var order2 = Object.getOwnPropertyNames(test2).
                            map(function (n) {
                                return test2[n]
                            })
                 ...
                 */
                    ...
                    if (process.env.NODE_ENV !== 'production') {
                        ...
                        warning = function warning(condition, format) {
                            ...
                            if (format.indexOf(
                                'Failed Composite propType: ') === 0) {
                                return // Ignore CompositeComponent proptype check.
                            }

                            if (!condition) {
                                for (var _len2 = arguments.length, args = Array(
                                    _len2 > 2
                                        ? _len2 - 2
                                        : 0), _key2 = 2; _key2 <
                                _len2; _key2++) {
            ...
            /***/ (function (module, exports) {
                ...
                var NumeralFormatter = function NumeralFormatter(
                    numeralDecimalMark, numeralIntegerScale,
                    numeralDecimalScale, numeralThousandsGroupStyle,
                    numeralPositiveOnly, stripLeadingZeroes, delimiter) {
                    var owner = this

                    owner.numeralDecimalMark = numeralDecimalMark || '.'
                    owner.numeralIntegerScale = numeralIntegerScale > 0
                        ? numeralIntegerScale
                        : 0
                    owner.numeralDecimalScale = numeralDecimalScale >= 0
                        ? numeralDecimalScale
                        : 2
                    ...
                    owner.delimiter = delimiter || delimiter === ''
                        ? delimiter
                        : ','
                    owner.delimiterRE = delimiter ? new RegExp('\\' + delimiter,
                        'g') : ''
                }
                ...
                NumeralFormatter.prototype = {
                    getRawValue: function getRawValue(value) {
                        return value.replace(this.delimiterRE, '').
                    ...
                    format: function format(value) {
                        ...
                        if (owner.numeralIntegerScale > 0) {
                            partInteger = partInteger.slice(0,
            ...
            /***/ (function (module, exports) {
                ...
                DateFormatter.prototype = {
                    ...
                    getFixedDateString: function getFixedDateString(value) {
                        ...
                        if (value.length === 4 &&
                            ...
                            day = parseInt(
                                ...
                                10)
                            month = parseInt(value.slice(monthStartIndex,
                                monthStartIndex + 2), 10)
                        ...
                        if (value.length === 8) {
                            ...
                            dayStartIndex = dayIndex <= yearIndex
                                ? dayIndex * 2
                                : dayIndex * 2 + 2
                            monthStartIndex = monthIndex <= yearIndex
                                ? monthIndex * 2
                                : monthIndex * 2 + 2
                        ...
                        return date.length === 0 ? value : datePattern.reduce(
                    ...
                    getFixedDate: function getFixedDate(day, month, year) {
                        ...
                        if (month < 7 && month % 2 === 0 || month > 8 && month %
                            2 === 1) {
                            day = Math.min(day, month === 2
            ...
            /***/ (function (module, exports) {
                ...
                var PhoneFormatter = function PhoneFormatter(
                    formatter, delimiter) {
                    var owner = this
                ...
                PhoneFormatter.prototype = {
                    ...
                    format: function format(phoneNumber) {
                        ...
                        for (var i = 0, iMax = phoneNumber.length; i <
                        iMax; i++) {
                            current = owner.formatter.inputDigit(
                    ...
                    getInfo: function getInfo(value, strictMode) {
                        ...
                        for (var key in re) {
                            if (re[key].test(value)) {
                                var block
                                if (key === 'discover' || key === 'maestro' ||
                                    key === 'visa' || key === 'mir' || key ===
                                    'unionPay') {
                                    block = strictMode
                                        ? blocks.generalStrict
                                        : blocks[key]
                                } else {
                                    block = blocks[key]
                                }
            ...
            /***/ (function (module, exports) {
                ...
                var Util = {
                    ...
                    stripDelimiters: function stripDelimiters(
                        value, delimiter, delimiters) {
                        var owner = this
                    ...
                    getPrefixStrippedValue: function getPrefixStrippedValue(
                        value, prefix, prefixLength) {
                        if (value.slice(0, prefixLength) !== prefix) {
                            var diffIndex = this.getFirstDiffIndex(prefix,
                    ...
                    getFirstDiffIndex: function getFirstDiffIndex(
                        prev, current) {
                        var index = 0
                    ...
                    getFormattedValue: function getFormattedValue(
                        value, blocks, blocksLength, delimiter, delimiters,
                        delimiterLazyShow) {
                        var result = '',
                        ...
                        blocks.forEach(function (length, index) {
                            if (value.length > 0) {
                                ...
                                if (multipleDelimiters) {
                                    currentDelimiter = delimiters[delimiterLazyShow
                                        ? index - 1
                                        : index] || currentDelimiter
                                } else {
                    ...
                    isAndroidBackspaceKeydown: function isAndroidBackspaceKeydown(
                        lastInputValue, currentInputValue) {
                        if (!this.isAndroid() || !lastInputValue ||
                            !currentInputValue) {
                            return false
                        }

                        return currentInputValue ===
                            lastInputValue.slice(0, -1)
                    },
                }
                ...
                (function (global) {
                    ...
                    var DefaultProperties = {
                        ...
                        assign: function assign(target, opts) {
                            ...
                            target.numeralIntegerScale = opts.numeralIntegerScale >
                            0 ? opts.numeralIntegerScale : 0
                            target.numeralDecimalScale = opts.numeralDecimalScale >=
                            0 ? opts.numeralDecimalScale : 2
                            target.numeralDecimalMark = opts.numeralDecimalMark ||
                                '.'
                            target.numeralThousandsGroupStyle = opts.numeralThousandsGroupStyle ||
                                'thousand'
                            target.numeralPositiveOnly = !!opts.numeralPositiveOnly
                            target.stripLeadingZeroes = opts.stripLeadingZeroes !==
                                false

                            // others
                            target.numericOnly = target.creditCard ||
                                target.date || !!opts.numericOnly

                            target.uppercase = !!opts.uppercase
                            target.lowercase = !!opts.lowercase

                            target.prefix = target.creditCard || target.date
                                ? ''
                                : opts.prefix || ''
                            ...
                            target.initValue = opts.initValue !== undefined &&
                            opts.initValue !== null
                                ? opts.initValue.toString()
                                : ''

                            target.delimiter = opts.delimiter ||
                            opts.delimiter === '' ? opts.delimiter : opts.date
                                ? '/'
                                : opts.numeral ? ',' : opts.phone ? ' ' : ' '
                            ...
                            target.root = (typeof global === 'undefined'
                                ? 'undefined'
