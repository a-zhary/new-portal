...
(function (mod) {
    ...
    function findMatchingBracket(cm, where, config) {
        ...
        if (config && config.strict && (dir > 0) !=
            (pos == where.ch)) return null
    ...
    CodeMirror.defineExtension('findMatchingBracket',
        function (pos, config, oldConfig) {
    ...
    CodeMirror.defineExtension('scanForBracket',
