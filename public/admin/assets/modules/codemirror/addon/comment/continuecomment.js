...
(function (mod) {
    ...
    function continueComment(cm) {
        ...
        for (var i = 0; i < ranges.length; i++) {
            ...
            if (!/\bcomment\b/.test(
                cm.getTokenTypeAt(pos))) return CodeMirror.Pass
            ...
            if (mode.blockCommentStart && mode.blockCommentContinue) {
                ...
                } else if ((found = line.lastIndexOf(mode.blockCommentStart)) >
                    -1 && found > end) {
            ...
            if (insert == null && mode.lineComment &&
                ...
                if (found > -1) {
                    ...
                    else insert += mode.lineComment +
                        line.slice(found + mode.lineComment.length).
                            match(/^\s*/)[0]
                }
            }
