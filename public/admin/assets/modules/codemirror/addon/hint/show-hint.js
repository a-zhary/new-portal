...
(function (mod) {
    ...
    CodeMirror.defineExtension('showHint', function (options) {
        ...
        if (this.somethingSelected()) {
            ...
            for (var i = 0; i < selections.length; i++)
                if (selections[i].head.line !=
                    selections[i].anchor.line) return
        }
    ...
    function Completion(cm, options) {
        ...
        cm.on('cursorActivity',
            this.activityFunc = function () { self.cursorActivity() })
    }
    ...
    Completion.prototype = {
        ...
        pick: function (data, i) {
            ...
            else this.cm.replaceRange(getText(completion),
        ...
        cursorActivity: function () {
            ...
            if (pos.line != this.startPos.line || line.length - pos.ch !=
                ...
                (pos.ch && this.options.closeCharacters.test(
                    line.charAt(pos.ch - 1)))) {
                this.close()
            } else {
                var self = this
        ...
        update: function (first) {
            ...
            fetchHints(this.options.hint, this.cm, this.options,
                function (data) {
    ...
    function getHintElement(hintsElement, el) {
        while (el && el != hintsElement) {
            if (el.nodeName.toUpperCase() === 'LI' && el.parentNode ==
                hintsElement) return el
            el = el.parentNode
        }
    }
    ...
    function Widget(completion, data) {
        ...
        if (completion.options.closeOnUnfocus) {
            ...
            cm.on('blur', this.onBlur = function () {
                closingOnBlur = setTimeout(function () { completion.close() },
                    100)
            })
            cm.on('focus',
                this.onFocus = function () { clearTimeout(closingOnBlur) })
        }
        ...
        cm.on('scroll', this.onScroll = function () {
            ...
            if (point <= editor.top || point >=
                editor.bottom) return completion.close()
        ...
        CodeMirror.signal(data, 'select', completions[this.selectedHint],
    ...
    Widget.prototype = {
        ...
        changeActive: function (i, avoidWrap) {
            ...
            if (node.offsetTop < this.hints.scrollTop)
                ...
                this.hints.scrollTop = node.offsetTop + node.offsetHeight -
                    this.hints.clientHeight + 3
