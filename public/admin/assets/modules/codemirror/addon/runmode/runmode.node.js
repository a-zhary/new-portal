...
StringStream.prototype = {
    ...
    lookAhead: function (n) {
        ...
        return line >= this.context.lines.length
            ? null
            : this.context.lines[line]
    },
}
...
require.cache[require.resolve(
    '../../lib/codemirror')] = require.cache[require.resolve('./runmode.node')]
require.cache[require.resolve(
    '../../addon/runmode/runmode')] = require.cache[require.resolve(
    './runmode.node')]
