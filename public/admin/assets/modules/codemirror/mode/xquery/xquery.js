    ...
    CodeMirror.defineMode('xquery', function () {
        ...
        var keywords = function () {
            ...
            var basic = [
                ...
                'words',
                'xquery']
            for (var i = 0, l = basic.length; i <
            l; i++) { kwObj[basic[i]] = kw(basic[i])}
            ...
            var operators = [
                ...
                '+',
                '-']
            for (var i = 0, l = operators.length; i <
            l; i++) { kwObj[operators[i]] = operator}
            ...
            var axis_specifiers = [
                ...
                'following-sibling::',
                'preceding-sibling::']
            for (var i = 0, l = axis_specifiers.length; i <
            l; i++) { kwObj[axis_specifiers[i]] = qualifier }
        ...
        function tokenBase(stream, state) {
            ...
            // close paren
                ...
                if (word == 'element' || word == 'attribute' || known.type ==
                    'axis_specifier') pushStateStack(state,
                    { type: 'xmlconstructor' })
        ...
        function tokenTag(name, isclose) {
            return function (stream, state) {
                ...
                if (!stream.eat('/'))
                    pushStateStack(state,
                        { type: 'tag', name: name, tokenize: tokenBase })
                if (!stream.eat('>')) {
        ...
        function tokenAttribute(stream, state) {
            ...
            if (!isInXmlAttributeBlock(state))
                pushStateStack(state,
                    { type: 'attribute', tokenize: tokenAttribute })
