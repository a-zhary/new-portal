...
(function () {
    ...
    function FT(name) {
        test.mode(name, modeHighlightFormatting,
            Array.prototype.slice.call(arguments, 1))
    }

    var modeMT_noXml = CodeMirror.getMode(config,
        { name: 'markdown', xml: false })
    ...
    var modeMT_noFencedHighlight = CodeMirror.getMode(config,
        { name: 'markdown', fencedCodeBlockHighlighting: false })

    function MT_noFencedHighlight(name) {
        test.mode(name, modeMT_noFencedHighlight,
            Array.prototype.slice.call(arguments, 1))
    }

    var modeAtxNoSpace = CodeMirror.getMode(config,
        { name: 'markdown', allowAtxHeaderWithoutSpace: true })

    function AtxNoSpaceTest(name) {
        test.mode(name, modeAtxNoSpace,
            Array.prototype.slice.call(arguments, 1))
    }
    ...
    function TokenTypeOverrideTest(name) {
        test.mode(name, modeOverrideClasses,
            Array.prototype.slice.call(arguments, 1))
    }
    ...
    function FormatTokenTypeOverrideTest(name) {
        test.mode(name, modeFormattingOverride,
            Array.prototype.slice.call(arguments, 1))
    }
