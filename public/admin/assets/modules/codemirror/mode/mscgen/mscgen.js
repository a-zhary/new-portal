    ...
    function produceTokenFunction(pConfig) {
        ...
        return function (pStream, pState) {
            ...
            if (!pState.inComment) {
                ...
                if (pStream.match(wordRegexp(pConfig.singlecomment), true,
                    true)) {
                    pStream.skipToEnd()
                    return 'comment'
                }
            ...
            if (pStream.match(wordRegexpBoundary(pConfig.arcsWords), true,
                true))
                return 'keyword'
            ...
            if (pConfig.inAttributeList) {
                if (pConfig.attributes !== null &&
                    pStream.match(wordRegexpBoundary(pConfig.attributes), true,
                        true)) {
                    return 'attribute'
                }
                if (pStream.match(/]/, true, true)) {
