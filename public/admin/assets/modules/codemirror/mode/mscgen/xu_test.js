...
(function () {
    ...
    MT('xù/ msgenny keywords classify as \'keyword\'',
        '[keyword watermark]',
        '[keyword alt]', '[keyword loop]', '[keyword opt]', '[keyword ref]',
        '[keyword else]', '[keyword break]', '[keyword par]', '[keyword seq]',
        '[keyword assert]',
    )
    ...
    MT('mscgen options classify as keyword',
        '[keyword hscale]', '[keyword width]', '[keyword arcgradient]',
    ...
    MT('within an attribute list, attributes classify as attribute',
        ...
        '[attribute linecolor]', '[attribute linecolour]',
        '[attribute textcolor]', '[attribute textcolour]',
        '[attribute textbgcolor]', '[attribute textbgcolour]',
        '[attribute arclinecolor]', '[attribute arclinecolour]',
        '[attribute arctextcolor]', '[attribute arctextcolour]',
        '[attribute arctextbgcolor]', '[attribute arctextbgcolour]',
    ...
    MT('outside an attribute list, attributes classify as base',
        ...
        '[base linecolor]', '[base linecolour]', '[base textcolor]',
        '[base textcolour]', '[base textbgcolor]', '[base textbgcolour]',
        '[base arclinecolor]', '[base arclinecolour]', '[base arctextcolor]',
        '[base arctextcolour]', '[base arctextbgcolor]',
