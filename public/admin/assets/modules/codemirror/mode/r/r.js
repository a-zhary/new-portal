    ...
    CodeMirror.defineMode('r', function (config) {
        ...
        return {
            ...
            token: function (stream, state) {
                ...
                if (style != 'comment' && (state.ctx.flags & ALIGN_NO) ==
                    0) setFlag(state, ALIGN_YES)

                if ((curPunc == ';' || curPunc == '{' || curPunc == '}') &&
                    state.ctx.type == 'block') pop(state)
            ...
            indent: function (state, textAfter) {
                ...
                if (ctx.type == 'block') return ctx.indent +
