...
(function (mod) {
    if (typeof exports == 'object' && typeof module == 'object') // CommonJS
        mod(require('../../lib/codemirror'), require('../python/python'),
            require('../stex/stex'), require('../../addon/mode/overlay'))
                ...
                switch (stage(state)) {
                    ...
                    case 3:
                        ...
                        if (state.tmp) {
                            ...
                            token = state.tmp.mode.token(stream,
                                state.tmp.local)
                            break
                        }
