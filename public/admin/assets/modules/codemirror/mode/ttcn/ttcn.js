...
(function (mod) {
    ...
    CodeMirror.defineMode('ttcn', function (config, parserConfig) {
        ...
        function tokenBase(stream, state) {
            ...
            if (verdictConsts.propertyIsEnumerable(
                cur)) return 'string verdictConsts'
            if (booleanConsts.propertyIsEnumerable(
                cur)) return 'string booleanConsts'
            if (otherConsts.propertyIsEnumerable(
                cur)) return 'string otherConsts'

            if (types.propertyIsEnumerable(cur)) return 'builtin types'
            if (visibilityModifiers.propertyIsEnumerable(cur))
                return 'builtin visibilityModifiers'
            if (templateMatch.propertyIsEnumerable(
                cur)) return 'atom templateMatch'
