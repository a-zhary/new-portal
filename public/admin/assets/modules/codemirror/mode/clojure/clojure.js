                ...
                switch (state.mode) {
                    ...
                    default: // default parsing mode
                        ...
                        if (ch == '"') {
                            ...
                            var keyWord = '', indentTemp = stream.column(),
                                letter
                            /**
                             Either
                             (indent-word ..
                            ...
                            if (ch == '(') while ((letter = stream.eat(
                                tests.keyword_char)) != null) {
                                keyWord += letter
                            }
                            ...
                            if (keyWord.length > 0 &&
                                ...
                                if (stream.eol() || stream.peek() == ';') {
                                    ...
                                    pushStack(state,
                                        indentTemp + NORMAL_INDENT_UNIT, ch)
                                } else {
                                    pushStack(state,
                            ...
                            if (keywords && keywords.propertyIsEnumerable(
                                stream.current())) {
                                returnType = KEYWORD
                            } else if (builtins &&
