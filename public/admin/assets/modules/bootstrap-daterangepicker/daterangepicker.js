...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        var moment = (typeof window != 'undefined' && typeof window.moment !=
            'undefined') ? window.moment : require('moment')
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        if (typeof options.ranges === 'object') {
            ...
            if (this.showCustomRangeLabel) {
                list += '<li data-range-key="' + this.locale.customRangeLabel +
        ...
        this.container.find('.calendar').
            ...
            on('mouseleave.daterangepicker', 'td.available',
            ...
            on('click.daterangepicker', '.daterangepicker_input input',
                $.proxy(this.showCalendars, this)).
            on('focus.daterangepicker', '.daterangepicker_input input',
                $.proxy(this.formInputsFocused, this)).
            on('blur.daterangepicker', '.daterangepicker_input input',
                $.proxy(this.formInputsBlurred, this)).
            on('change.daterangepicker', '.daterangepicker_input input',
                $.proxy(this.formInputsChanged, this)).
            on('keydown.daterangepicker', '.daterangepicker_input input',
        ...
        this.container.find('.ranges').
            ...
            on('mouseleave.daterangepicker', 'li',
                $.proxy(this.updateFormInputs, this))
    ...
    DateRangePicker.prototype = {
        ...
        setStartDate: function (startDate) {
            ...
            if (this.timePicker && this.timePickerIncrement)
                this.startDate.minute(Math.round(
            ...
            if (this.maxDate && this.startDate.isAfter(this.maxDate)) {
                ...
                if (this.timePicker && this.timePickerIncrement)
                    this.startDate.minute(Math.floor(
                            this.startDate.minute() / this.timePickerIncrement) *
                        this.timePickerIncrement)
            }
        ...
        setEndDate: function (endDate) {
            ...
            if (this.timePicker && this.timePickerIncrement)
                this.endDate.minute(Math.round(
        ...
        updateMonthsInView: function () {
            if (this.endDate) {
                ...
                if (this.leftCalendar.month.format('YYYY-MM') !=
                    this.startDate.format('YYYY-MM') &&
                    this.rightCalendar.month.format('YYYY-MM') !=
                    this.startDate.format('YYYY-MM')) {
                    this.leftCalendar.month = this.startDate.clone().date(2)
            ...
            if (this.maxDate && this.linkedCalendars &&
                !this.singleDatePicker && this.rightCalendar.month >
                this.maxDate) {
        ...
        updateCalendars: function () {
            ...
            if (this.timePicker) {
                ...
                if (this.endDate) {
                    hour = parseInt(
                        this.container.find('.left .hourselect').val(), 10)
                    minute = parseInt(
                        this.container.find('.left .minuteselect').val(), 10)
                    ...
                    minute = parseInt(
                        this.container.find('.right .minuteselect').val(), 10)
                    second = this.timePickerSeconds
                        ? parseInt(
        ...
        renderCalendar: function (side) {
            ...
            var curDate = moment(
                [lastYear, lastMonth, startDay, 12, minute, second])

            var col, row
            for (var i = 0, col = 0, row = 0; i <
            42; i++, col++, curDate = moment(curDate).add(24, 'hour')) {
                if (i > 0 && col % 7 === 0) {
                    col = 0
                    row++
                }
                ...
                if (this.minDate && calendar[row][col].format('YYYY-MM-DD') ==
                    ...
                    calendar[row][col].isBefore(this.minDate) && side ==
                    'left') {
                    calendar[row][col] = this.minDate.clone()
                }

                if (this.maxDate && calendar[row][col].format('YYYY-MM-DD') ==
                    this.maxDate.format('YYYY-MM-DD') &&
                    calendar[row][col].isAfter(this.maxDate) && side ==
                    'right') {
            ...
            if ((!maxDate || maxDate.isAfter(calendar.lastDay)) &&
                (!this.linkedCalendars || side == 'right' ||
            ...
            for (var row = 0; row < 6; row++) {
                ...
                if (this.showWeekNumbers)
                    ...
                    html += '<td class="week">' + calendar[row][0].isoWeek() +
                        '</td>'
        ...
        renderTimePicker: function (side) {
            ...
            if (side == 'left') {
                ...
                if (timeSelector.html() != '') {
                    ...
                    selected.hour(
                        timeSelector.find('.hourselect option:selected').
                            val() || selected.hour())
                    selected.minute(
                        timeSelector.find('.minuteselect option:selected').
                            val() || selected.minute())
                    selected.second(
                        timeSelector.find('.secondselect option:selected').
                            val() || selected.second())
        ...
        move: function () {
            ...
            if (this.drops == 'up')
                containerTop = this.element.offset().top -
                    this.container.outerHeight() - parentOffset.top
            else
                containerTop = this.element.offset().top +
            ...
            if (this.opens == 'left') {
                this.container.css({
                    top: containerTop,
                    right: parentRightEdge - this.element.offset().left -
        ...
        show: function (e) {
            ...
            this._outsideClickProxy = $.proxy(
                function (e) { this.outsideClick(e) }, this)
            ...
            $(window).
                on('resize.daterangepicker',
                    $.proxy(function (e) { this.move(e) }, this))
        ...
        calculateChosenLabel: function () {
            ...
            for (var range in this.ranges) {
                if (this.timePicker) {
                    ...
                    if (this.startDate.format(format) ==
                    ...
                    if (this.startDate.format('YYYY-MM-DD') ==
        ...
        monthOrYearChanged: function (e) {
            ...
            if (!isLeft) {
                if (year < this.startDate.year() ||
                    (year == this.startDate.year() && month <
        ...
        timeChanged: function (e) {
            ...
            var second = this.timePickerSeconds ? parseInt(
                cal.find('.secondselect').val(), 10) : 0
            ...
            if (isLeft) {
                ...
                if (this.singleDatePicker) {
                    this.endDate = this.startDate.clone()
                } else if (this.endDate && this.endDate.format('YYYY-MM-DD') ==
